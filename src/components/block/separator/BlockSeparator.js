        ...
        <svg viewBox="0 0 1200 300"  className={classes.BlockSeparator} preserveAspectRatio="none">
          <defs>
            ...
            <g clipPath="url(#_clipPath_mN1cZdwAGGcYFGZO1uBwrrBeliFO0QWh)">
              <polygon points="1220,310,-20,310,600,0" fill="rgb(255,255,255)" vector-effect="non-scaling-stroke" strokeWidth="1" stroke="rgb(36,66,189)" strokeLinejoin="miter" strokeLinecap="square" strokeMiterlimit="5"/>
            </g>
        </svg>
      ...
      <div className={classes.BlockSeparatorHolder}>
        <svg viewBox="0 0 1200 250"  className={classes.BlockSeparator} preserveAspectRatio="none">
          ...
          <g clipPath="url(#_clipPath_rrO3p6oswYn16OxuRyK4aYyqjvHaF3uw)">
            <path d=" M 0 124 C 169.026 282.685 178.136 286.18 400 124 C 621.864 -38.18 578.864 -41.6 800 124 C 1021.136 289.6 987.535 285.938 1200 124" fill="none" vector-effect="non-scaling-stroke" strokeWidth="1" stroke="rgb(36,66,189)" strokeLinejoin="miter" strokeLinecap="square" strokeMiterlimit="3"/>
          </g>
        </svg>
