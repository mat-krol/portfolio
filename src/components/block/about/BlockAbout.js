  ...
  return (
    <div className={classes.BlockAbout} id="about">
      ...
      <div className={classes.BlockAboutContent}>
        ...
        {/* <div className={classes.BlockAboutContentCopy}> */}
      ...
      <span>I have 1 year of professional experience using React to create apps and prototypes as well as Gatsby for static sites.</span>
